...
export class LoginComponent implements OnInit {
  ...
  login() {
    ...
    if (username == 'requester' && password == 'requester') {
      delete getdata.password;
      getdata.roleid = 3;
      localStorage.setItem("Daim-forms", JSON.stringify(getdata));
      this.router.navigateByUrl('/dashboard/bus-assesment');
    }
    else if (username == 'processor' && password == 'processor') {
      delete getdata.password;
      getdata.roleid = 4;
      localStorage.setItem("Daim-forms", JSON.stringify(getdata));
      this.router.navigateByUrl('/dashboard/bus-assesment');
    ...
    else if (username == 'L3' && password == 'L3') {
      delete getdata.password;
      getdata.roleid = 6;
      localStorage.setItem("Daim-forms", JSON.stringify(getdata));
      this.router.navigateByUrl('/dashboard/bus-assesment');
    }
    else if (username == 'L4' && password == 'L4') {
      delete getdata.password;
      getdata.roleid = 7;
      localStorage.setItem("Daim-forms", JSON.stringify(getdata));
      this.router.navigateByUrl('/dashboard/bus-assesment');
